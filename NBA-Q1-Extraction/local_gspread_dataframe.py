#################################################################################################################################################
# link: https://github.com/robin900/gspread-dataframe/blob/master/gspread_dataframe.py
# date: 11/23/2022
# objective: instead of using a layer in AWS Lambda, I will directly reference this file and replace "six" with original code (for Python 3)
#################################################################################################################################################
